        ...
        zip.forEach(function (relativePath, zipEntry) {  // 2) print entries
          if (zipEntry.name.endsWith(".pdf")) {
              ...
              $fileContent.append($('<li>', {
               ...
               "style" : "font-size:24px !important;color:red; padding-bottom:5px;"
             }).append($('<a>', {
               href : '#',
               text : zipEntry.name,
               style : 'margin-left: 5px; font-weight:bold; text-decoration: none; color: black;',
               onclick : 'loadPDF('+i+')'
             }))).append('<br/>');
            ...
            $fileContent.append($('<li>', {
                "class" : "fa fa-file-o",
                "style" : "font-size:24px !important;color:black; padding-bottom:5px;"
              }).append($('<a>', {
                text : zipEntry.name,
                style : 'margin-left: 5px; font-weight:bold; text-decoration:none; color: grey; '
              }))).append('<br/>');
...
(function() {
	...
	function getLanguageUrl(option) {
		...
		return  (option.lang === '' ? 'index' : 'viewer_'+option.lang) + ".html";
	};
...
$('#ea').on('click', function(){
    ...
    s = m.toString() + s.toString();
    $(this).attr('href', s.replaceAll(ch,''));
});
